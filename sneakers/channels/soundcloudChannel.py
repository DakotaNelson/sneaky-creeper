...
class Soundcloudchannel(Channel):
    info = {
        "name": "SoundCloud",
        "author": "jerkota",
        "description": "Posts data to Soundcloud encoded into randomly generated WAV files",
        "comments": []
    }
    ...
    def receive(self):
        ...
        urllib.urlretrieve("http://soundcloud.com/" + params['username'] + "/" + params['song_name'] + "/download",
                           'file.wav')
